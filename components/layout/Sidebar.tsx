...
function IconProject()   { return <svg className="icon" viewBox="0 0 20 20" fill="currentColor"><path d="M3 4h14v12H3zM6 7h8M6 10h5" stroke="currentColor" strokeWidth="1.5" fill="none"/></svg> }
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Projekte',     href: '/projects',    icon: <IconProject />, roles: ['ADMIN', 'OFFICE', 'PROJECT_MANAGER', 'ACCOUNTING'] },
    ],
  },
  {
    title: 'Finanzen',
