  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="card-base max-w-md p-8 text-center">
        ...
        <Link href="/collaboration/dashboard" className="mt-6 inline-flex rounded-md bg-blue-700 px-4 py-2 text-sm font-600 text-white hover:bg-blue-800">Zur Übersicht</Link>
      </div>
    </main>
  )
}
